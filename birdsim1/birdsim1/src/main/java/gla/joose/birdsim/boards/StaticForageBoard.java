...
public class StaticForageBoard extends Board{
	...
	public StaticForageBoard(int rows, int columns) {
		...
		setFlyBehaviour( new FlyImplementation2(this));	// which of the fly methods should be used - I'm a moving forage board want this one implementation2
	...
	public void initBoard(final JFrame frame) {
        ...
        feedBirdButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	// variable name changed from starvedBirdsPressed
            	starveBirds = false;
