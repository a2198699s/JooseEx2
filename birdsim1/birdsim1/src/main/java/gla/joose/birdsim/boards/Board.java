...
public abstract class Board extends Observable implements Observer {
    ...
    public FlyBehaviourInterface fbi ;
    ...
    public void setFlyBehaviour(FlyBehaviourInterface fbi ) {
        this.fbi = fbi;	// actually need to say which of the two implementations you want
      }  
    ...
    public void performFly(){
    	fbi.fly();			// call the fly method of the implementation the subclass requested through set fly behaviour
    }
